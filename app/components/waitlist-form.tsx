...
export function WaitlistForm({ onSuccess }: WaitlistFormProps) {
  ...
  return (
    <form action={handleSubmit} className="w-full space-y-4 mb-8">
      <div className="flex overflow-hidden rounded-xl bg-white/5 p-1 ring-1 ring-white/20 focus-within:ring-2 focus-within:ring-[#8B1F3F]">
        <Input
          id="email"
          name="email"
          type="email"
        ...
        <Button
          type="submit"
          disabled={isPending}
          className="bg-[#8B1F3F] hover:bg-[#6B1730] text-white font-semibold px-4 rounded-xl transition-all duration-300 ease-in-out focus:outline-none w-[120px]"
        >
